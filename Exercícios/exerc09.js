...
function exercicio09() {
  ...
  while (condicaoFimDoPrograma) {
    ...
    let continuar = Number(
      prompt(
        "Digite 1 se você deseja continuar, para sair apenas digite qualquer outra coisa \n :",
      ),
    );
  ...
  console.log(
    `O total pago para funcinarios do sexo masculino foi: R$${salarioMasculino}`,
  );
  console.log(
    `O total pago para funcinarios do sexo feminino foi: R$${salarioFeminino}`,
  );
}
